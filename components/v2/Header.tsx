...
export const Header = () => {
  return (
    <header className="relative w-full min-h-screen px-16 overflow-hidden mt-8 transition-colors duration-300">
      ...
      <div className="absolute top-1/2 left-20 w-8 h-8 bg-[#CC66DA] rounded-full opacity-40 dark:opacity-50 animate-ping"></div>

      {/* Node.js - Coin supérieur gauche */}
      <div className="absolute top-16 left-90 w-12 h-12 rounded-lg border-2 border-gray-100 dark:border-gray-700 animate-float z-5 opacity-60 hover:opacity-90 transition-opacity">
      ...
      <div className="absolute bottom-25 right-35 w-12 h-12 rounded-lg border-2 border-gray-100 dark:border-gray-700 animate-float-delay-2 z-5 opacity-60 hover:opacity-90 transition-opacity">
        <div className="relative w-full h-full rounded-lg bg-white/20 dark:bg-gray-800/30 backdrop-blur-sm shadow-lg border border-white/30 dark:border-gray-600/30 p-2 flex items-center justify-center">
          <NestIcon></NestIcon>
        </div>
      </div>
      ...
      <div className="absolute bottom-35 left-130 w-12 h-12 rounded-lg border-2 border-gray-100 dark:border-gray-700 animate-float z-5 opacity-60 hover:opacity-90 transition-opacity">
        <div className="relative w-full h-full rounded-lg bg-white/20 dark:bg-gray-800/30 backdrop-blur-sm shadow-lg border border-white/30 dark:border-gray-600/30 p-2 flex items-center justify-center">
      ...
      <div className="absolute top-1/2 left-2 w-12 h-12 rounded-lg border-2 border-gray-100 dark:border-gray-700 animate-float-delay z-5 opacity-60 hover:opacity-90 transition-opacity">
        <div className="relative w-full h-full rounded-lg bg-white/20 dark:bg-gray-800/30 backdrop-blur-sm shadow-lg border border-white/30 dark:border-gray-600/30 p-2 flex items-center justify-center">
          <ReactIcon></ReactIcon>
        </div>
      </div>
      ...
      <div className="absolute top-1/2 right-1/3 w-12 h-12 rounded-lg border-2 border-gray-100 dark:border-gray-700 animate-float-delay-2 z-5 opacity-60 hover:opacity-90 transition-opacity">
        <div className="relative w-full h-full rounded-lg bg-white/20 dark:bg-gray-800/30 backdrop-blur-sm shadow-lg border border-white/30 dark:border-gray-600/30 p-2 flex items-center justify-center">
      ...
      {/* Express */}
      <div className="absolute top-1/2 right-8 w-12 h-12 rounded-lg border-2 border-gray-100 dark:border-gray-700 animate-float-delay-2 z-5 opacity-60 hover:opacity-90 transition-opacity">
        <div className="relative w-full h-full rounded-lg bg-white/20 dark:bg-gray-800/30 backdrop-blur-sm shadow-lg border border-white/30 dark:border-gray-600/30 p-2 flex items-center justify-center">
      ...
      <div className="relative z-10 container mx-auto px-6 min-h-screen flex items-center">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4 w-full">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {/* Titre Principal */}
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold monument mb-6 text-gray-900 dark:text-white leading-tight">
            ...
            <h2 className="monument text-3xl md:text-4xl mb-6 flex flex-wrap items-center justify-center lg:justify-start gap-3">
              <span className="bg-gradient-to-r from-[#CC66DA] to-purple-600 px-4 py-2 rounded-none text-white shadow-lg transform hover:scale-105 transition-transform">
                Backend
              </span>
            ...
            {/* Description */}
            <p className="text-gray-600 dark:text-gray-400 text-xl mb-8 max-w-2xl leading-relaxed">
          ...
          {/* Section Avatar */}
          <div className="relative flex-shrink-0 lg:flex-shrink-1">
            {/* Avatar principal */}
            <div className="relative z-10 group">
              <Image
                ...
                width={350}
                height={350}
                className="relative z-20 border-4 rounded-full border-white dark:border-gray-300 shadow-2xl"
                priority
              />

              {/* Badges flottants */}
              <div className="absolute -bottom-2 -left-4 bg-white dark:bg-gray-800 text-[#CC66DA] px-3 py-1 rounded-full text-sm font-semibold shadow-lg border border-[#CC66DA]">
                3+ Years
              </div>
            </div>
          </div>
